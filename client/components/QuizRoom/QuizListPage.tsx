...
import { Trophy, Timer, Target, Send, AlertCircle,BarChart3,
} from 'lucide-react';
...
export default function QuizListPage() {
  ...
  const [players, setPlayers] = useState<MatchRanking[]>([
    { id: 1, username: 'You', score: 0, answered: 0 },
    { id: 2, username: 'Alex Thunder', score: 420, answered: 8 },
    { id: 3, username: 'Jordan Smith', score: 380, answered: 7 },
    { id: 4, username: 'Casey Brown', score: 350, answered: 7 },
  ]);
  ...
  const handleAnswerChange = useCallback((questionId: number, answerIndex: number) => {
    // console.log(`Question ${questionId} answered with option index ${answerIndex}`);
